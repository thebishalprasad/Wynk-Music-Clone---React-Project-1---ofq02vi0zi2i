...
export const MusicPlayer = ({ song, playerRef }) => {
  ...
  return (
    <section ref={playerRef} className="fixed bottom-0 h-20 w-full bg-slate-800 py-2 items-center gap-5 hidden z-50" id="player">
      <div className="absolute top-0 w-full player_range__Y0p1N">
        <input type="range" min="0" max="100" step="1" className="h-8 absolute -bottom-4 w-full cursor-pointer" value={song.progress}/>
      </div>
