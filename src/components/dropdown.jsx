...
const dropdown = () => {
  return (
    <div class="hidden lg:block h-full dark:text-white">
    <div class="relative h-full flex items-center" data-headlessui-state="open">
        <button class="ml-[1.375rem]" type="button" aria-expanded="true" data-headlessui-state="open" id="headlessui-popover-button-:Rv696:" aria-controls="headlessui-popover-panel-:r28:">
            <span class="w-6 h-6 dark:text-white">
                <span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                    <path d="M3.75 12.1211H20.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                    <path d="M3.75 6.12109H20.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                    <path d="M3.75 18.1211H20.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>
                </span>
            </span>
        </button>
        ...
        <button type="button" aria-hidden="true" style="position: fixed; top: 1px; left: 1px; width: 1px; height: 0px; padding: 0px; margin: -1px; overflow: hidden; clip: rect(0px, 0px, 0px, 0px); white-space: nowrap; border-width: 0px;"></button>
        <div class="bg-white border-wynk-borderWhite z-30 absolute top-full mt-2 w-64 h-fit dark:bg-wynk-HeaderPopDark -bottom-[152px] right-0 pt-5 rounded-xl stroke-2 -mr-5 shadow-popover transform opacity-100 scale-100" id="headlessui-popover-panel-:r28:" tabindex="-1" data-headlessui-state="open">
            <span class="user_popover_trinleShap__lPN9S"></span>
            <div class="flex flex-col px-4">
                <div class="flex items-center gap-3 hover:opacity-60">
                    <span>
                    ...
                    <span class="font-light opacity-80">+918961498714</span>
                </div>
            </div>
            <div>
                <div class="flex items-center gap-3 hover:opacity-60 cursor-pointer mb-5 px-4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" class="inline-block" stroke="currentColor">
                        <path d="M12 7V15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                        <path d="M9 13L11.6464 15.6464C11.8417 15.8417 12.1583 15.8417 12.3536 15.6464L15 13" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                        <circle cx="12" cy="12" r="9.25" stroke="currentColor" stroke-width="1.5"></circle>
                    </svg>
                    <span class="font-light opacity-80">Download App</span>
                </div>
            </div>
            <div class="flex items-center gap-3 hover:opacity-60 cursor-pointer mb-5 px-4">
                <span>
                ...
                <span class="font-light opacity-80">Select Language</span>
            </div>
            <div class="flex items-center gap-3 hover:opacity-60 cursor-pointer mb-5 px-4">
                <span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                ...
                <span class="font-light opacity-80">Sound Quality</span>
            </div>
            <a class="flex items-center gap-3 stroke-2 hover:opacity-60 cursor-pointer mb-5 px-4" href="/podcasts">
                <span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                ...
                <span class="font-light opacity-80">Podcast</span>
            </a>
            <div>
                <div>
                    <div class="flex items-center gap-3 hover:opacity-60 cursor-pointer mb-5 px-4">
