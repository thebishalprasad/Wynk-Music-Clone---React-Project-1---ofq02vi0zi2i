...
const Dropdown = () => {
  return (
    <div className="hidden lg:block h-full dark:text-white">
    <div className="relative h-full flex items-center" data-headlessui-state="open">
        <button className="ml-[1.375rem]" type="button" aria-expanded="true" data-headlessui-state="open" id="headlessui-popover-button-:Rv696:" aria-controls="headlessui-popover-panel-:r28:">
            <span className="w-6 h-6 dark:text-white">
                <span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                    <path d="M3.75 12.1211H20.25" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                    <path d="M3.75 6.12109H20.25" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                    <path d="M3.75 18.1211H20.25" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path></svg>
                </span>
            </span>
        </button>
        ...
        <button type="button" aria-hidden="true" style="position: fixed; top: 1px; left: 1px; width: 1px; height: 0px; padding: 0px; margin: -1px; overflow: hidden; clip: rect(0px, 0px, 0px, 0px); white-space: nowrap; border-width: 0px;"></button>
        <div className="bg-white border-wynk-borderWhite z-30 absolute top-full mt-2 w-64 h-fit dark:bg-wynk-HeaderPopDark -bottom-[152px] right-0 pt-5 rounded-xl stroke-2 -mr-5 shadow-popover transform opacity-100 scale-100" id="headlessui-popover-panel-:r28:" tabindex="-1" data-headlessui-state="open">
            <span className="user_popover_trinleShap__lPN9S"></span>
            ...
            <div className="flex items-center gap-3 hover:opacity-60 cursor-pointer mb-5 px-4">
                <span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                        ...
                        <path d="M4.56978 16.4891C4.26853 17.8974 4.64773 20.6046 8.57452 20.1673" stroke="currentColor" strokeWidth="0.8"></path>
                        <path d="M7.76624 19.2633L8.69669 20.074L7.76624 21.0635" stroke="currentColor" strokeWidth="0.8" strokeLinecap="round" strokeLinejoin="round"></path>
                        <path d="M3.55902 17.4042L4.36152 16.4737L5.3188 17.4042" stroke="currentColor" strokeWidth="0.8" strokeLinecap="round" strokeLinejoin="round"></path>
                    </svg>
                </span>
            ...
            <div className="flex items-center gap-3 hover:opacity-60 cursor-pointer mb-5 px-4">
                <span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                        <path d="M5.75 10.5281H3V14.4581H5.75V10.5281Z" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"></path>
                        <path d="M12.57 19.3181L5.75 14.4481V10.5181L12.57 5.64811C13.18 5.21811 14 5.67811 14 6.46811V18.4981C14 19.2881 13.18 19.7581 12.57 19.3181Z" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"></path>
                        <path d="M19.24 8.24811C20.33 9.32811 21 10.8281 21 12.4881C21 14.1481 20.33 15.6481 19.24 16.7281" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"></path>
                        <path d="M17.12 10.3681C17.66 10.9081 18 11.6581 18 12.4881C18 13.3181 17.66 14.0681 17.12 14.6081" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"></path>
                        <path d="M14 11.4881C14.55 11.4881 15 11.9381 15 12.4881C15 13.0381 14.55 13.4881 14 13.4881" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"></path>
                    </svg>
                </span>
                        ...
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                                <g clip-path="url(#clip0_604_622)">
                                    ...
                                    <path d="M9.09998 20.9001H5.59998V4.80011H9.09998" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"></path>
        ...
        <button id="headlessui-focus-sentinel-after-:r2a:" data-headlessui-focus-guard="true" type="button" aria-hidden="true" style="position: fixed; top: 1px; left: 1px; width: 1px; height: 0px; padding: 0px; margin: -1px; overflow: hidden; clip: rect(0px, 0px, 0px, 0px); white-space: nowrap; border-width: 0px;"></button>
    </div>
</div>
)
}
